...
async function getSession() {
    // const res = await fetch('https://abdelkrimn.promo-23.codeur.online/meteo/weather/session', {method: "POST"});
    const res = await fetch('https://meteo.abdelkrim-naji.com/weather/session', {method: "POST"});
...
function displayData(retourReponse) {
    ...
    weatherImg.src = "meteo/Assets/img/weather-icons/" + retourReponse.currently.icon + ".svg";
...
function displayHourly() {
    ...
    weatherImg.src = "meteo/Assets/img/weather-icons/" + result.hourly.data[setTime.value].icon + ".svg";
...
function getPreviousDay() {
    ...
    fetch("https://meteo.abdelkrim-naji.com/weather/get", {method: "POST", body: data})
    .then((retourReponse) => {
        return retourReponse.json();
    })
    .then((retourReponse) => {
